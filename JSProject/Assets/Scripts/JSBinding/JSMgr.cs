...
public static class JSMgr
{
    ...
    public static string jsDir = Util.DataPath + "JavaScript";
    public static string jsRelDir = Application.dataPath + "/StreamingAssets/JavaScript";
    public static string jsGenFile { get { return jsDir + "/Gen1" + jsExtension; } }
    public static string jsGenByBridgeFile { get { return jsRelDir + "/Gen2" + jsExtension; } }
